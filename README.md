...
# curl -L -o ViT-B_16.npz "https://storage.googleapis.com/vit_models/imagenet21k/ViT-B_16.npz"
...
----
v1 - 
python train.py --name cifar10_bs64_acc8 --dataset cifar10 --model_type ViT-B_16 --pretrained_dir checkpoint/ViT-B_16.npz --train_batch_size 64 --gradient_accumulation_steps 8
