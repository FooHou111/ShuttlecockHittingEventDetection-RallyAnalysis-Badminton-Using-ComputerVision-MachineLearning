...
def setup(args):
    ...
    state = ckpt.get('state_dict', ckpt)   # in case it's wrapped
...
def main():
    ...
    csvPath1 = r"C:\Users\user\Badminton\src\ViT-pytorch_Hitter\golfdb_G3_fold5_iter3000_val_test_hitter_vote.csv"    ################################ 3. csv-path ################################
    csvPath2 = r"C:\Users\user\Badminton\src\ViT-pytorch_Hitter\golfdb_G3_fold5_iter3000_val_test_hitter_mean.csv"   ################################ 3. csv-path ################################
    ...
    df1['RoundHead'] = Hitter    ################################ 4. attribute ################################
    df1.to_csv('golfdb_G3_fold5_iter3000_val_test_hitter_vote_roundhead_vote.csv', index=False)    ################################ 5. csv-name ################################
    ...
    df2['RoundHead'] = Hitter    ################################ 4. attribute ################################
    df2.to_csv('golfdb_G3_fold5_iter3000_val_test_hitter_mean_roundhead_mean.csv', index=False)    ################################ 5. csv-name ################################
