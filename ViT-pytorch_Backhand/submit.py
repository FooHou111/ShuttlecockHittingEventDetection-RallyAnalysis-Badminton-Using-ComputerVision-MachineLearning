...
def main():
    ...
    csvPath1 = r"C:\Users\user\Badminton\src\ViT-pytorch_RoundHead\golfdb_G3_fold5_iter3000_val_test_hitter_vote_roundhead_vote.csv"    ################################ 3. csv-path ################################
    csvPath2 = r"C:\Users\user\Badminton\src\ViT-pytorch_RoundHead\golfdb_G3_fold5_iter3000_val_test_hitter_mean_roundhead_mean.csv"    ################################ 3. csv-path ################################
    ...
    df1['Backhand'] = Hitter    ################################ 4. attribute ################################
    df1.to_csv('golfdb_G3_fold5_iter3000_val_test_hitter_vote_roundhead_vote_backhand_vote.csv', index=False)    ################################ 5. csv-name ################################
    ...
    df2['Backhand'] = Hitter    ################################ 4. attribute ################################
    df2.to_csv('golfdb_G3_fold5_iter3000_val_test_hitter_mean_roundhead_mean_backhand_mean.csv', index=False)    ################################ 5. csv-name ################################
