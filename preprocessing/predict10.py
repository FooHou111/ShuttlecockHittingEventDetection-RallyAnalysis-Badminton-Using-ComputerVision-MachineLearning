...
parser.add_argument('--video_name', type=str,
                    default=r"..\..\preprocess\val_test_xgg",
                    help='input video path OR folder (default: val_test_xgg)')
parser.add_argument('--lr', type = float, default = 1e-1, help = 'learning rate (default: 0.1)')
parser.add_argument('--load_weight', type=str,
                    default=r"C:\PASTE\YOUR\TRACKNET_WEIGHT.pth.tar",
...
############### TrackNet ################
model = TrackNet(input_height=288, input_width=512)
model.to(device)
